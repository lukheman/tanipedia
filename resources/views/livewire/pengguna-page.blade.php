            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content shadow-lg rounded-3">
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="mb-3">
                                ...
                                <input wire:model="name" type="text" class="form-control" id="name" name="name" placeholder="Masukkan nama" @if ($currentState === \App\Enums\State::SHOW) disabled @endif>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input wire:model="email" type="email" class="form-control" id="email" name="email" placeholder="Masukkan email" @if ($currentState === \App\Enums\State::SHOW) disabled @endif>
                                @error('email')
                                    <small class="d-block mt-1 text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label for="desa" class="form-label fw-semibold">Desa</label>
                                        <select wire:model.live="desa" class="form-control" id="desa" @if ($currentState === \App\Enums\State::SHOW) disabled @endif>
                            ...
                            <div class="mb-3">
                                ...
                                <input wire:model="alamat" type="text" class="form-control" id="alamat" name="alamat" placeholder="Contoh: Jl. Pemuda" @if ($currentState === \App\Enums\State::SHOW) disabled @endif>
                                @error('alamat')
                                    <small class="d-block mt-1 text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input wire:model="telepon" type="text" class="form-control" id="telepon" name="telepon" placeholder="Masukkan nomor telepon" @if ($currentState === \App\Enums\State::SHOW) disabled @endif>
                                        @error('telepon')
                                            <small class="d-block mt-1 text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input wire:model="tanggal_lahir" type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" @if ($currentState === \App\Enums\State::SHOW) disabled @endif>
                                        @error('tanggal_lahir')
                                            <small class="d-block mt-1 text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        @endif
                        <!-- <button type="button" class="btn btn-secondary" wire:click="$dispatch('closeModal', {id: 'modal-form-pengguna'})">Tutup</button> -->
                    </div>
                </div>
            </div>
        </div>

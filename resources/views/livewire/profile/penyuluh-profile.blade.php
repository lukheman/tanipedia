        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-center align-items-center flex-column">
                    ...
                    <p class="text-small text-muted">Penyuluh Pertanian</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select wire:model.live="kecamatan" id="kecamatan" class="form-control">
...
<select wire:model="form.id_desa" wire:key="desa-{{ $kecamatan }}" id="desa" class="form-control">

...
Route::get('/jadwal-penyuluhan', \App\Livewire\JadwalPenyuluhanTable::class)->name('jadwal-penyuluhan')->middleware(MultiAuth::class.':penyuluh,petani');
...
Route::get('/cetak-laporan/petani/{id}/{tahun}', [LaporanController::class, 'laporanPetani'])
    ->name('print-laporan.petani')->middleware(MultiAuth::class.':kepala_dinas');
Route::get('/cetak-laporan/ahli-pertanian/{id}/{tahun}', [LaporanController::class, 'laporanAhliPertanian'])->name('print-laporan.ahli-pertanian')->middleware(MultiAuth::class.':kepala_dinas');
